...
DEFAULT_SNAKE_LENGTH: int = 12
DEFAULT_SNAKE_WIDTH = 8
DEFAULT_SEGMENT_LENGTH_RANGE: Tuple[int] = (15, 20)
DEFAULT_IMAGE_MARGINS: Tuple[int] = (50, 50)
DEFAULT_TEXT: str = "snek\nit\nup"
DEFAULT_TEXT_POSITION: Tuple[int] = (DEFAULT_IMAGE_MARGINS[0], DEFAULT_IMAGE_MARGINS[1])
